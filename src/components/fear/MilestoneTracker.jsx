...
export default function MilestoneTracker() {
  ...
  return (
    <div style={{ padding: '24px', backgroundColor: 'var(--bg-surface)', borderRadius: '16px', border: '1px solid var(--border-default)' }}>
       <h3 style={{ margin: '0 0 8px 0', color: 'var(--text-primary)' }}>Fear Milestones</h3>
             ...
             return (
                <motion.div 
                  ...
                  style={{
                    ...
                    backgroundColor: unlocked ? 'var(--green-dim)' : 'var(--bg-surface-2)',
                    border: `1px solid ${unlocked ? 'var(--green)' : 'var(--border-subtle)'}`,
                ...
                >
                  ...
                  {unlocked && (
                     <div style={{ position: 'absolute', top: '8px', right: '8px', color: 'var(--green)', fontSize: '12px' }}>
                       ✓
                     </div>
                  )}
                </motion.div>
